    ...
    <ModalPane id={ModalName.Settings} title='Settings' visible={visible} onClose={onClose}>
      <SettingsContent>
        ...
        <Section>
          ...
          Dark Forest Adventure account on different browsers. You should save this info somewhere
          on your computer.
          <Spacer height={16} />
        ...
        <Section>
          ...
          transaction times across browsers, and ${BLOCKCHAIN_NAME} transaction errors, to help us
          optimize performance and fix bugs. This does not include personal data like email or IP
          address.
          <Spacer height={8} />
          <BooleanSetting
            uiManager={uiManager}

...
export const TOKEN_NAME = 'AGLD';
export const BLOCKCHAIN_NAME = 'Adventure Layer';
export const HOST_TEAM_NAME = 'AGLD DAO';

export const GAS_ADJUST_DELTA = '1'; // '0.000000001'; //'1'; //'0.00000005';
...
export const BLOCK_EXPLORER_URL = 'https://explorer-devnet.adventurelayer.xyz' as const;

...
const defaultInitializerValues = {
  ...
  CLAIM_END_TIMESTAMP: '3031-05-27T18:59:59.000Z',
  ...
  BURN_END_TIMESTAMP: '3031-05-27T18:59:59.000Z',
  BURN_PLANET_COOLDOWN: 60 * 60 * 3,
  PINK_PLANET_COOLDOWN: 60 * 60 * 3,
  ACTIVATE_ARTIFACT_COOLDOWN: 60 * 60 * 3,
  BUY_ARTIFACT_COOLDOWN: 60 * 60 * 3,

  BUY_ENERGY_COOLDOWN: 60 * 60 * 3,
